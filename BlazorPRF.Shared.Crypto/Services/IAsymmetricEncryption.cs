...
public interface IAsymmetricEncryption
{
    ...
    ValueTask<PrfResult<EncryptedMessage>> SignAndEncryptAsync(
        string message,
    ...
    /// </summary>
    /// <param name="encrypted">The encrypted message (may include signature)</param>
    ...
    ValueTask<PrfResult<DecryptedMessage>> DecryptAndVerifyAsync(
