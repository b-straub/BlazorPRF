using BlazorPRF.BaseCrypto.Server;
...
{
    Console.WriteLine("""
        BlazorPRF.BaseCrypto.Wasm CLI - Ed25519 Sign/Verify Tool

        Compatible with BlazorPRF.BaseCrypto.Wasm TypeScript implementation.
        ...
        Examples:
          # Verify a signature from BlazorPRF.BaseCrypto.Wasm
          blazorprfbase-cli verify "Hello" "sig..." "pubkey..."

          # Generate a new key pair
          blazorprfbase-cli keygen

          # Sign a message
          blazorprfbase-cli sign "Hello" "privatekey..."
