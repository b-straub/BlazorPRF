/**
 * BlazorPRF.Wasm.Crypto - Combined WebAuthn PRF + WebCrypto
 *
        ...
        const credential = await navigator.credentials.create({
            publicKey: {
                ...
                user: {
                    ...
                    displayName: displayName || "BlazorPRFWasm User"
                },
                pubKeyCredParams: [
    ...
    const encryptionKey = await crypto.subtle.deriveKey(
        {
            name: "HKDF",
            hash: "SHA-256",
            salt: new TextEncoder().encode("BlazorPRFWasm-encryption"),
    ...
    const signingKeyBits = await crypto.subtle.deriveBits(
        {
            name: "HKDF",
            hash: "SHA-256",
            salt: new TextEncoder().encode("BlazorPRFWasm-signing"),
