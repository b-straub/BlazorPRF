...
namespace BlazorPRF.Wasm.Crypto.Interop;

/// <summary>
/// JavaScript interop for BlazorPRF.Wasm.Crypto using JSImport.
...
{
    private const string ModuleName = "BlazorPRFWasm";
    ...
    private static async Task InitializeAsync()
    {
        ...
        await JSHost.ImportAsync("BlazorPRFWasmHelper",
        ...
        var modulePath = $"{baseHref}_content/BlazorPRF.Wasm.Crypto/blazorprf-wasm-crypto.js";

        await JSHost.ImportAsync(ModuleName, modulePath);
    }

    [JSImport("getBaseHref", "BlazorPRFWasmHelper")]
